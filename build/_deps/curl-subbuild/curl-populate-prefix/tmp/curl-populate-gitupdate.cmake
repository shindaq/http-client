...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "curl-8_5_0"
  WORKING_DIRECTORY "/home/shindaq/mirea/projects/http-client/build/_deps/curl-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("curl-8_5_0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/curl-8_5_0")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/shindaq/mirea/projects/http-client/build/_deps/curl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/shindaq/mirea/projects/http-client/build/_deps/curl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
